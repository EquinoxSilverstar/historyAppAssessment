...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        generateButton.setOnClickListener {
            val enterAge = editTextNumber.text.toString().trim()
            if (isValidAge(enterAge)) {
                val age = enterAge.toInt()
                    ...
                    40 -> "Jesus Christ; he died for our sins and is son of God,he created christianity"
                        67 -> "Leonardo da Vinci; he was a italian polymath of the High Renaissance who was a active painter" +
                                " ,draughtsman and many more"
                        30 -> "Patsy Cline;she was a American singer whose talent and wide-ranging appeal made her one of the" +
                                " classic performers of the genre"
                        43 -> "Lucky Dube;he was a South African reggae musician,like Bob Marley, he was one of the best reggae artists,singing about social problems."
                     92 -> "Albertina Sisulu; she was a political activist and also high profile of anti-apartheid resistance in South Africa"
                    32 -> "Bruce Lee; was a American born film actor who renowned for martial arts prowess and martial arts movies popular"
                      76 -> "Albert Einstein; he was a German Theoretical physicist who won Nobel Prize for Physics in 1921 and the most influential physicist"
                      58 -> "Andy Warhol; was a American visual artist and film director ,also a leading exponent of the Pop art movement"
                        28 -> " Heath Ledger; he was a Australian actor, known for his moving and amazing performances in diverses roles and awarded an Oscar for his " +
                       ...
                       100 -> "George Burns he was an American comedian and was known as part of a popular comedy"
                            else -> " no one listed within this list , try again and try 40"
                    }
